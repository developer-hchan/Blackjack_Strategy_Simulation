...
* **Dealer Hits on Soft 17:** Usually, casinos have dealer's hit on **soft 17** rather than stand in order to potentially get a better hand
  * Sometimes you'll see "dealer stands on **soft 17**" which means the dealer will not hit but end their turn instead
...
* **Blackjack Bonus:** is usually 1.5 * *the original bet* a.k.a as "blackjack pays 3:2"
  * Sometimes this varies, another common ratio is "blackjack pays 6:5" which is equivalent to 1.1 * *the original bet*
