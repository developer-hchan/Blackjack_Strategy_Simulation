...
class SimulationCases:
    """
    Class that constructs the case generators for regular and split cases.
    """
    ...
    def __init__(self, settings: dict) -> None:
        ...
        # This property is used to limit how many cases are worked on at one time during the multiprocessing
        # section in __main__.py when simulating regular cases
